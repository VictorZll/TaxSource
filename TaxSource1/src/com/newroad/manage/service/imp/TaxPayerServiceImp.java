...
import com.newroad.manage.dao.TaxPayer1Mapper;
...
public class TaxPayerServiceImp implements TaxPayerServiceIf {
	...
	private TaxPayer1Mapper dao=session.getMapper(TaxPayer1Mapper.class);
	@Override
	public List<TaxPayer1> listByPage(String pageStr, String rowsStr,String payerCode,String payerName) {
		...
		List<TaxPayer1> list=dao.listByPage(offset, rows,qc);
		return list;
	}
	@Override
	...
	@Override
	public TaxPayer1 getSingleData(String payerCode) {
		if(payerCode==null) {payerCode="";};
		return dao.querySingleData(payerCode);
	}
	@Override
	public boolean add(TaxPayer1 taxPayer) {
	...
	@Override
	public boolean update(TaxPayer1 taxpayer, String payerCode) {
