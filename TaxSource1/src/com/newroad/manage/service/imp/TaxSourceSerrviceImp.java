...
import com.newroad.manage.dao.TaxSource1Mapper;
...
public class TaxSourceSerrviceImp implements TaxSourceServiceIf {
	...
	TaxSource1Mapper dao=session.getMapper(TaxSource1Mapper.class);

	@Override
	public boolean addTaxSource(TaxSource1 t) {
	...
	@Override
	public List<TaxSource1> listByPage(String pageStr, String rowsStr,String[] conditions) {
		...
		List<TaxSource1> list=dao.listByPage(offset, rows,qc);
		return list;
	}
	...
	@Override
	public TaxSource1 getTaxSourceById(String idStr) {
		int id=Integer.parseInt(idStr);
		TaxSource1 t=dao.selectByPrimaryKey(id);
		return t;
	}
}
