...
import com.newroad.manage.service.imp.TaxPayerServiceImp;
...
public class TaxPayerServlet extends BaseServlet {
	//获得Service对象
		TaxPayerServiceIf service=new TaxPayerServiceImp();
	/**
	...
	public void page(HttpServletRequest request, HttpServletResponse response) {
		...
		//查询数据
		List<TaxPayer1> list=service.listByPage(pageStr, rowsStr,payerCode,payerName);
	...
	public void edit(HttpServletRequest request, HttpServletResponse response) {
		...
		String payerCode=request.getParameter("payerCode");
		//根据参数获得要修改的对象
		TaxPayer1 taxPayer=service.getSingleData(payerCode);
	...
	public void save(HttpServletRequest request, HttpServletResponse response) {
		...
		TaxPayer1 taxPayer=new TaxPayer1();
